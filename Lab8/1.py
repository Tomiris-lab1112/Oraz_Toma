...
# Audio setup 
pygame.mixer.init()
pygame.mixer.music.load('c:\\Users\\orazt\\Downloads\\background.wav')  # Background music
pygame.mixer.music.play(-1)  # Loop infinitely
crash_sound = pygame.mixer.Sound('c:\\Users\\orazt\\Downloads\\crash.wav')  # Collision sound
...
class Coin(pygame.sprite.Sprite):
    ...
    def move(self):
        ...
        if self.rect.top > SCREEN_HEIGHT:
            # Reset coin to a new random position above the screen
